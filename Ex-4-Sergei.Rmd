...
```{r}
infected <- function(network1, network2, network3, p=0.8){
tel1 = 0
tel2 = 0
tel3 = 0

for (i in 0:99){
  tel1 = tel1 + IC("107", network1, p,c(), 40)
  tel2 = tel2 + IC("107", network2, p, c(54,20, 110), 40)
  tel3 = tel3 + IC("107", network3, p, c(37,4, 96 ), 40)
