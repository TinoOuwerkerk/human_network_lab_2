...
# Sort the edge_betweenness vector in descending order
sorted_edges <- sort(edge_betweenness, decreasing = TRUE)

# Select the top 5 edges with the highest betweenness centrality
top5_edges <- sorted_edges[1:5]

# Delete the top 5 edges from the Highschool object
sub_graph <- delete_edges(Highschool, E(Highschool)[edge_betweenness %in% top5_edges])
average.path.length(sub_graph)
```
## Question 10
